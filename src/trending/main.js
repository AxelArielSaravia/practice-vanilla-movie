...
window.addEventListener("DOMContentLoaded", function () {
    ...
    DOM.buttonMore.addEventListener("click", function (e) {
        ...
        addItems(
            G.API.getTrending(qmediaType, String(State.page)),
            qmediaType,
            DOM
        );
        State.page += 1;
    ...
    //Data
    var trendingPromise = G.API.getTrending(qmediaType, String(State.page));
    State.page += 1;
    var trendingPromise2 = G.API.getTrending(qmediaType, String(State.page));
    State.page += 1;
    ...
    trendingPromise2.then(function (data) {
        if (data?.results === undefined || data.results.length === 0) {
            State.ended = true;
            return;
        }
